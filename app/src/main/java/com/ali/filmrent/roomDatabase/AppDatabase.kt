...
@Database(
    version = 1,
    exportSchema = false,
    entities = [Customer::class, Film::class, Manager::class, Store::class, Actor::class, BuyedInventory::class, Category::class, Language::class, Payment::class, Rental::class, RentedFilm::class]
)
